...
- The AI + ActionBoard knowledge layer defines scoped records, evidence references, review statuses, freshness, and credential-free support context, with one main-process access boundary that filters before and after retrieval for local owners and delegated support (#41–#42, AIAB-01–02, Project 8).
