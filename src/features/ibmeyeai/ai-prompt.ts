    ...
    return [
        {
            ...
            content: [
                ...
                'For selected-job guidance, use exactly these sections: Observed facts, Matching evidence, Interpretation, Missing evidence, Suggested checks, Approved procedure, and Next safe action.',
                'Cite each material fact or procedure with the exact [citation:...] marker supplied in the matching evidence. If there is no matching citation, label the claim unknown.',
